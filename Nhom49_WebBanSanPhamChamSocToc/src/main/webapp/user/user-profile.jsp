                ...
                <div class="bg-white rounded-3 shadow-sm p-4">
                    ...
                    <div class="row g-4">
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="mt-3">
                                <div class="mb-2"><strong>Email:</strong> ${requestScope.user.email}</div>
                                <div class="mb-2"><strong>Tên đăng nhập:</strong> ${requestScope.user.username}</div>
                                <div class="mb-2"><strong>Số điện thoại:</strong> ${requestScope.user.phone}</div>
                            </div>
                        </div>
