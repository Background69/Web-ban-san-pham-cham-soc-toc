                ...
                <ul class="side-bar-menu-list side-bar-items">
                    ...
                    <li class="nav-item has-dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="${pageContext.request.contextPath}/store?category=kem-u"><i
                                    class="fas fa-jar text-warning me-2"></i>Kem ủ – Mặt nạ tóc</a></li>
                            <li><a class="dropdown-item" href="${pageContext.request.contextPath}/store?category=serum"><i
                            ...
                            <li><a class="dropdown-item"
                                   href="${pageContext.request.contextPath}/store?category=xit-duong"><i
                                    class="fas fa-spray-can text-success me-2"></i>Xịt dưỡng – Tinh chất dưỡng</a></li>
                            <li><a class="dropdown-item"
